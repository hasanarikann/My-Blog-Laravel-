        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="content">
                        <img src="{{asset('assets')}}/images/blog/post-1.jpg" alt="post-thumb" class="img-fluid rounded float-left mr-5 mb-4">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="bg-gray p-5 mb-4">
                        <div class="media border-bottom py-4">
                            <img src="{{asset('assets')}}/images/user-1.jpg" class="img-fluid align-self-start rounded-circle mr-3" alt="">
                            <div class="media-body">
                                ...
                                <div class="media my-5">
                                    <img src="{{asset('assets')}}/images/user-2.jpg" class="img-fluid align-self-start rounded-circle mr-3" alt="">
                                    <div class="media-body">
                        ...
                        <div class="media py-4">
                            <img src="{{asset('assets')}}/images/user-3.jpg" class="img-fluid align-self-start rounded-circle mr-3" alt="">
                            <div class="media-body">
